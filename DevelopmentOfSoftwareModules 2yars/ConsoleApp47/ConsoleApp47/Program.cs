...
// добавить возможномть вывода информации о поезде номер которого введен пользователем 
// добавить возможномть сортировки массива по пунтку назначения
// причем пезда с одинаковым пунктами назначения должна быть упорядочена по времени отправления
